    ...
    <div className="flex flex-col justify-between min-h-screen p-4 bg-white max-w-md mx-auto">
      <div>
        <div className="bg-gray-100">
          <button className="text-sm text-red-600 mb-2">
            &larr; Volver a Tareas Asignadas
          </button>

          <h1 className="text-xl font-bold text-gray-800">
            Posicionamiento de cable minero eléctrico sobre el pretil utilizando
            equipo de apoyo
          </h1>
        </div>
        <p className="mt-2 text-gray-700">
          Realiza el Análisis de Riesgo para completar la información acerca de
          la tarea.
        </p>

        <h2 className="mt-4 font-bold text-lg text-teal-800">
          Son solo 3 pasos:
        </h2>
        ...
        <ul className="mt-2 space-y-4">
          {[
            ...
            <li
              key={i}
              className="flex items-start p-3 bg-gray-100 rounded-lg shadow-sm"
            >
