  ...
  return (
    <div className="p-4 max-w-md mx-auto min-h-screen bg-white">
      ...
      <section className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 shadow-sm">
        <div className="flex justify-between items-center mb-2">
          ...
          {video ? (
            ...
            <span className="text-pink-700 text-xs font-semibold">
              Pendiente
            </span>
          )}
        </div>
        ...
        <div className="flex flex-col gap-2">
          <button className="w-full border border-teal-700 text-teal-700 py-2 rounded-md">
            Subir video
          </button>
      ...
      <section className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 shadow-sm">
        ...
        <p className="text-sm text-gray-700 mb-4">
          <span className="font-semibold">Instrucciones: </span>
          Revisa las Estrategias de Control qu ecorresponden a la tarea y/o
          agrega nuevas.
        </p>
        <button className="w-full bg-teal-700 text-white py-2 rounded-md">
