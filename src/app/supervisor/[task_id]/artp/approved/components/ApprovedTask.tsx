...
interface ApprovedTaskProps {
    taskData: Task
}

export default function ApprovedTask({ taskData }: ApprovedTaskProps) {
            ...
            <div className="bg-white p-4 shadow-sm">
                ...
                <div className="px-6 py-12 flex flex-col items-center justify-center min-h-[60vh]">
                    <div className="bg-white rounded-2xl shadow-lg p-12 text-center max-w-md w-full">
                        <div className="mb-6">
                            <CheckCircle className="h-20 w-20 text-teal-800 mx-auto mb-4" />
                            <h3 className="text-2xl font-bold text-gray-800 mb-2">¡Tarea Aprobada con Éxito!</h3>
                            <p className="text-gray-600">
                                El Análisis de Riesgo de la Tarea Planificado ha sido aprobado correctamente.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            <Button
                                ...
                                className="w-full bg-teal-700 hover:bg-teal-800 text-white py-3 text-lg font-semibold"
                                size="lg"
                            >
                                Volver a Inicio
                            </Button>
