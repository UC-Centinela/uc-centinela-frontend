...
export function TaskDetailsDialog({
  ...
  const renderStatusBadge = (state: Task["state"]) => {
    switch (state) {
      ...
      case "IN_PROGRESS":
        return (
          <Badge className="bg-[#3b82f6] hover:bg-[#2563eb]">Asignada</Badge>
        );
      case "COMPLETED":
        return (
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Información completa y opciones para la tarea seleccionada
          </DialogDescription>
        </DialogHeader>
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-80">
                    <div className="space-y-4">
                      ...
                      <Select
                        onValueChange={(value) =>
                          onReassignResponsible(task.id, Number(value))
                        }
                      >
                        <SelectTrigger>
