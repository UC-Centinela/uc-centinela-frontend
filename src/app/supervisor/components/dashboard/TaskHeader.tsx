    ...
    <header className="bg-white p-4 shadow-sm">
      <div className="max-w-7xl mx-auto">
        <div className="mb-4 flex justify-between items-center">
          <div>
            <h6 className="text-xs text-[#666666] font-medium">Supervisor de evaluación de riesgo</h6>
            <h1 className="text-[#176170] font-semibold text-xl">Tareas Minera Centinela</h1>
          </div>
